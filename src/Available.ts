import {SpiderIsolate,SpiderIsolateMirror,bundleScope,LexScope} from "spiders.js";
import {_IS_EVENTUAL_KEY_} from "./Eventual";
var _EV_KEY_ = _IS_EVENTUAL_KEY_
var _IS_AVAILABLE_KEY_ = "_IS_AVAILABLE_"
export class Available extends SpiderIsolate{
    constructor(){
...
export class AvailableMirror extends SpiderIsolateMirror{
    checkArg(arg){
